...
document.getElementById('btn_regresar').addEventListener('click', function () {
    window.location.href = 'https://palletsalfatexcoco.com.mx/inicio/';
});
...
document.getElementById("btn_login").addEventListener("click", function () {
    ...
    function validarContraseña() {
        ...
        if (pass.value !== key) {
            error_login.textContent = `Contraseña incorrecta, si no tiene acceso al sito contacte a un vendedor, por favor`;
